...
<script>
    ...
    <div class="col-md-7 well right-column">
        ...
        <div class="btn-group btn-group-justified" role="group">
            ...
            <div class="btn-group" role="group">
              <a href="<?= $this->Url->build(['controller' => 'Feedback', 'action' => 'medication'])?>" role="button" class="btn btn-primary">Medication</a>
            </div>
            <div class="btn-group" role="group">
    ...
    <div class="row">
        <div class="col-md-10">
            <?= $this->Html->link('<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Previous', ['controller' => 'feedback', 'action' => 'counseling'], ['class' => 'btn btn-default btn-md previous-button', 'escape' => false])?>
        </div>
        <div class="col-md-2 pull-right">
            <?= $this->Html->link('Next <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>', ['controller' => 'feedback', 'action' => 'referral'], ['class' => 'btn btn-default btn-md pull-right', 'escape' => false])?>
        </div>
    </div>
