...
<div class="row two-column-video">
    ...
    <div class="row">
        <div class="col-md-12 pull-right">
            <?= $this->Html->link('Next <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>', ['controller' => 'history_questions', 'action' => 'index'], ['class' => 'btn btn-default btn-md pull-right', 'escape' => false])?>
        </div>
    </div>
