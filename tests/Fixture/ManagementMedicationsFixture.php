...
/**
 * ManagementMedicationsFixture
 *
 */
class ManagementMedicationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'medication_id' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'medication_order' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'medication_group' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'feedback_only' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'medication_text' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'management_medications_ibfk_1' => ['type' => 'foreign', 'columns' => ['all_cases_id'], 'references' => ['all_cases', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'medication_id' => 'Lor',
            'medication_order' => 1,
            'medication_group' => 'Lorem ipsum dolor sit amet',
            'feedback_only' => 'Lor',
            ...
            'created' => '2015-11-25 00:01:13',
            'modified' => '2015-11-25 00:01:13'
        ],
    ];
}
